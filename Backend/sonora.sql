 ...
 * -------------------------------------------------------------------
 * Módulo: Esquema de Base de Datos (MySQL)
 * Descripción: En este archivo definimos la estructura de datos de Sonora.
 *              Hemos diseñado 5 tablas principales para gestionar autores,
 *              canciones, categorías, licencias y usuarios, asegurando la 
